...
<body>
    ...
    <div class="container-xl px-4 mt-4">
        ...
        <div class="col-xl-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if (isset($_POST['update_profile'])) {
                        ...
                        mysqli_query($conn, "UPDATE `users` SET first_name = '$update_name', last_name = '$update_last', email = '$update_email', phone = '$update_phone', birthday = '$update_date' WHERE first_name= '$name'") or die('query failed');
                    }
                    ?>
            ...
            <div class="back"><button><a href="index.php">GO BACK</a></button></div>
        </div>
