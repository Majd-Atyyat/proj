...
if (isset($_POST['btn_addcart'])) {
	...
	// array_push($_SESSION["cart"],$items_arr);
	// $items = array_column($_SESSION["cart"], $productid );
	// $items_arr= array( 
	...
	// );
	// $_SESSION["cart"]=array_push($items,$items_arr);
	// // print_r($items) ;
	// print_r($_SESSION["cart"]);
							...
							<?= $row["description"]?>
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" name="add_to_cart_id">
											Add to cart
										</button>
									</div>
								</div>	
